...
public class TutorialMainMethod : MonoBehaviour
{
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
    void Start()
    {
        ...
        infoText.text = "WELCOME to 'Heros & Horrors' an interactive card game! Please press the draw Hero button to begin the tutorial...";
    }
